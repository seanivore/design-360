...
### **Urgent Covid-19 Response Platform** 
...
### **Body Awareness Coach & Online Personal Trainer**
...
### Webflow & Framer CMS Shop & Lookbooks 
...
# **ENTRY TITLE**: Art Director Web3 Branding
...
## 200+ Weekly Blogs With Art 
`https://www.august.style/animated-cms-weekly-blogs/`
`https://generative-horoscopes.august.style/`
`https://developer-technologist.august.style/scaling-ai-brand`

  + Showed off the website above
    - Frame differently 
    - Show off the content pipeline this time

  + Art Store Automated Backend & Updates 
    `https://developer-technologist.august.style/full-stack-automated-ecommerce`
  + Automated CMS Management 
    `https://www.august.style/automated-e-commerce-shop-lookbook/`

## Agentic Social Media & Marketing teams

  + Created API video shorts from database and posted to social 
    `https://www.instagram.com/p/DAWqgtwS1HP/`
...
### Classic Simple Online Store
`https://design.august.style/projects/webflow-print-series`
`https://www.august.style/minimalist-web-store-product/`

### **AI Data Dashboard Visualization**
`https://www.august.style/data-visualization-dashboard/`
`https://design.august.style/projects/ai-admin-dashboard`
