...
**Created**: 2026-05-21
**Updated**: 2026-05-21
**Update Details**: Copy-edit pass on PHASE_A1_v2.md — typos and grammar corrected, the back-half prose tightened (especially the Strategic Architect intro). No structural or factual changes. One award attribution flagged inline (`**FLAG**`) for Sean to confirm.
**Original**: `assets/docs/archive/v4_0/PHASE_A1_v2.md` (pre-restructure original kept at `assets/docs/archive/v4_0/PHASE_A1.md`)
**Status**: Review — copy-edit applied, awaiting Sean's check
**Structure**: 
...
Together, we left a lasting impression on the history of the organization, influenced the lifestyle choices of literal *billions* of people, all while pioneering strategies that later became industry standards. 

### Our First Viral Moments

Experimenting with new platform features and formats, we tapped into the frontier of social media marketing. Adding powerful taglines to visuals created topical narratives — and that hit even harder because no other brands were designing graphics on the fly.
...
**BULLETED LIST WITH INDENTED SUB-LISTS**
  ...
  + The results: 
    ...
    - People saw the abuse that produced their beloved UGGs 

  + Big picture: 
    - Our first major public success taught me what became my newest favorite term: "earned media".
    - Vitality like this was relatively novel, and YahooNews quickly posted a story about the campaign that included the image inside the Tweet.
    - In the years to come, piggybacking our social posts to get clicks became a popular tactic for media outlets.

It didn't take long before we had gotten a reputation for crashing the GLOBAL organization's robust website by sending hundreds of thousands of visits in just minutes. 

In these early years both Facebook and BuzzFeed were requesting meetings with us to discuss our new social media strategy. 

#### Witty [Superbowl Tweet](https://x.com/peta/status/430123610359885824) Goes Viral

**MEDIA: Single row with this on the left `assets/.media/awards-viral-social/flow-awards-viral-social-02.webp`, and then the embed HTML below which is the actual tweet. Edit the HTML as needed for display, and please preview the image layout and take my notes as suggestions, opting for whatever looks best.**
...
**BULLETED LIST WITH INDENTED SUB-LISTS**
  + Why live coverage:
    - Helena had come to the organization with robust experience covering Hollywood red carpet events. 
    - I thrived in the fast paced environment, spit-balling ideas, and pulling from my powerful visual-focused memory of exactly what images we had as resources. 
    - It was an opportunity to insert our messages into real-time, national conversations; a rare opportunity to speak to the entire country at once.

  + Our process: 
    - Sitting together in the office with a large TV, we carefully watched for opportunities that could be tied back to our messaging priorities.
    - Helena would constantly draft possible phrasing and blurbs that might evolve into tweets or captions.
  ...
  + The execution:
    - The resulting post had a technically beautiful photograph of an animal on a farm, that had a haunting feel we tapped into by adding the words "NOT YOURS TO WEAR"
    - The tagline doubled as a direct statement AT Joe Namath; this is what we called "sharability" because posting to your own feed represented in users a statement of their own feelings or identity. 
    - Viral status was all but guaranteed — our correspondents tapped celebrities to kick off the re-sharing.
...
In short order, Facebook added video sharing. Our tactics were the same: Be the first brand editing videos on the fly. Garnering multi-millions of impressions per post, our video work almost immediately started grabbing the attention of colleagues around the globe. 

The online growth was staggering and the success was quickly acknowledged in-house when the financial investment into our work increased tenfold. This was our opportunity to grow our team right alongside our audience, hiring assistants, strategists, and eventually an entirely new department that started out creating video exclusively for social media.

### Leveraging Engagement To Influence Culture

In little more than a month we were ready to flex this newly established audience-base. We knew from the start of planning a campaign that we could access enough engagement to capture media outlet attention, allowing us to adjust our strategic focus in a powerful way.

#### [Hijacking the #AskSeaWorld Online Campaign](https://x.com/peta/status/581552543530139648)

**MEDIA: One row with two visuals, first `assets/.media/awards-viral-social/flow-awards-viral-social-04.webp` and then on the right embed the tweet HTML below.**
...
**BULLETED LIST WITH INDENTED SUB-LISTS**
  + SeaWorld's dumbest PR campaign: 
    - SeaWorld, a target of the organization, can't have realized how quickly our online community had grown. 
    - They launched a campaign meant to offset declining attendance. 
    - SeaWorld told the whole internet they should tweet with #AskSeaWorld to learn their truth about how they help animals.

**MEDIA: one row with two images with `assets/.media/awards-viral-social/flow-awards-viral-social-05.webp` on the left and then `assets/.media/awards-viral-social/flow-awards-viral-social-06.webp` on the right.**

**BULLETED LIST WITH INDENTED SUB-LISTS**
  + Our opportunistic strategy: 
    - We quickly had our video labs department craft a video about their animal treatment that was optimized for social media.
    - This was paired with our organization posts joining the hashtag to showcase the animal abuse. 
    - Tweet images used the same emotional gut check tactic in our posts, which our newly massive audience amplified.
    - Our followers couldn't get enough of calling out a problematic company straight to their face.
    - Beyond coordinating social media platforms, we leveraged direct marketing to ask our most committed supported to join in, too.

**MEDIA: one row with two images with `assets/.media/awards-viral-social/flow-awards-viral-social-07.webp` on the left and `assets/.media/awards-viral-social/flow-awards-viral-social-08.webp` on the right.**

**BULLETED LIST WITH INDENTED SUB-LISTS**
  + The results: 
    - The SeaWorld campaign rapidly failed, as it was impossible to find any information that was supportive in their hashtag. 
    - Our content creation now demonstrated the full impact of coordinated social media activism. 
    - News outlets and blogs quickly started covering our movement instead of SeaWorld's intended message.
    ...
    - Most impressively, AdWeek chimed in with ["PETA Pokes Fun at Ongoing SeaWorld PR Campaign"](https://www.adweek.com/agencyspy/peta-pokes-fun-at-ongoing-seaworld-pr-campaign/)
...
**BULLETED LIST WITH INDENTED SUB-LISTS**
  + Beating industry benchmarks:
    - PRNews Pro covered our extremely high engagement rate, comparing us favorably to other organizations. 
...
**BULLETED LIST WITH INDENTED SUB-LISTS**
  + How we achieved it:
    - The strategies have been highlighted through this portfolio where results of Helena and my innovation and dedication.
    ...
    - Content was always optimized for each specific platform, and often involved coordinated direct marketing email and SMS pushes to amplify messaging.
...
**MEDIA: the only image for this row is `assets/.media/awards-viral-social/flow-awards-viral-social-11.webp`**

These new milestones continued to allow our roles to shift. I was promoted to Marketing Innovations Assistant Manager, a highly autonomous role: I looked across every department for where I could make the biggest improvements. I also hired my own staff of remote and in-office direct reports who corresponded with everyone who commented on every post — we're talking thousands of people a day — as well as bringing some of the communications department into social media and digital marketing by hiring a correspondent who just focused on celebrity and influence engagement. 
