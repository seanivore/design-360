...
Once cleaned up, make sure agent uses best practices for mobile first design. Right now the mock-up homepage is horrible on mobile. 
`/Users/seanivore/Development/360-design/.agent/2026_MOBILE_DESIGN_SPECS.md`
...
**FastCompany Article reject `UX/UI Designer` title** 
...
Use these to recreate homepage content and sections. 
...
This current one won't work. 

  > I build things that work and look like they shouldn't be free.

### 3. `.hero-subtitle`

This one won't work. 

  > Full-stack developer, designer, and automation engineer who ships production systems — from SaaS conversion flows to 800-product e-commerce stores.
