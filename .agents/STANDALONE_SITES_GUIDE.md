# Standalone Sites — A Subdirectory as Its Own Site, on Its Own Subdomain
...
## What This Is
  ...
  A **standalone** is a small static site that lives inside a bigger repo, deploys as its own Vercel project, and answers on its own subdomain. You send someone a link and it does its job.
